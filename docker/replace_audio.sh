...
mkdir -p audio_only output_enhance output_denoise output
...
resemble-enhance audio_only output_denoise --denoise_only
resemble-enhance output_denoise output_enhance
...
rm output_denoise/audio.wav
rm output_enhance/audio.wav
